...
/*export default class Maratona3 {
  //fs = require("fs");
  ...
  public f(x: number, counter: number) {
    if (counter == 11) {
...
class NumberToWords {
  ...
  public f(x: number, counter: number): number {
    if (counter == 1000) {
      return this.len(x).length;
    }
    return this.f(this.len(x).length, counter + 1);
  }
}
...
/* import Maratona3 from "./maratonaBrute";

let teste = new Maratona3();
console.log(teste.len(4));
console.log(teste.len(13));
console.log(teste.len(19));
console.log(teste.len(21));
console.log(teste.len(99));
console.log(teste.f(4, 0));
console.log(teste.f(12, 0));
 */
